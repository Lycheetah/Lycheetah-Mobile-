...
const VV_LORE: Record<string, string> = {
  ...
  // ─── ASH suit (Nigredo / Fire / Wands) ───────────────────────────────────
  'Ace of Wands':    'Before there is flame there is intent — a single impulse crossing the threshold from not-yet to beginning. You do not need more than this to start.',
  'Two of Wands':    'You are holding heat you have not yet released. The capacity is real. The question is not whether to burn — it is where.',
  'Three of Wands':  'Something has broken open and the fire is no longer contained by the old structure. This is not failure. The fire needed more room.',
  'Four of Wands':   'The forge is here. The fire is here. The pause before work begins has its own dignity — not rest, not avoidance. Preparation that knows its own weight.',
  'Five of Wands':   'The sparks go in every direction. This is real energy — unfocused but not wasted. Contain without extinguishing.',
  'Six of Wands':    'You are carrying something that could reignite. The coal travels. What you have survived is not gone — it is portable.',
  'Seven of Wands':  'You are standing in your own smoke, seeing through it, not moving. Endurance is a choice made every moment without ceremony.',
  'Eight of Wands':  'The fire is directed now. This is the burn that is going somewhere. What has been gathered has reached critical mass.',
  'Nine of Wands':   'Keeping the fire through the night alone is the hardest kind of faithfulness. You are still here. The fire is still here.',
  'Ten of Wands':    'The full burn does not mean the end. What remains after complete combustion is ash — and ash is the beginning of the next thing.',
  'Page of Wands':   'The one who has just felt the first fire. Does not know what it will become — only that it is real and must be followed. Curiosity before mastery; the impulse that begins the burn.',
  'Knight of Wands': 'The burn has been tested against reality and it survived. The will applied to what is difficult, and kept moving. This is fire that knows where it is going.',
  'Queen of Wands':  'What has burned and what must not burn. Warmth without destruction — the one who has stood in the furnace long enough to know its moods and trust them.',
  'King of Wands':   'Mastery of transformation without being consumed. Fire in service. The full knowledge of what the Nigredo costs and what it produces — held without flinching.',

  // ─── VEIL suit (Albedo / Water / Cups) ───────────────────────────────────
  'Ace of Cups':     'Before feeling becomes complicated by memory and expectation, there is one clean moment of pure reception. This is that moment. Let it land.',
  'Two of Cups':     'You are reflecting something and being reflected. The recognition between two people that they are looking at the same real thing — that is the gift here.',
  'Three of Cups':   'After the burning comes the clearing. What was heavy is being rinsed away. This is not forgetting — this is the body releasing what it no longer needs to carry.',
  'Four of Cups':    'The water is perfectly still. You have stopped moving in order to see what is actually in it. Stillness is not absence of feeling — it is its precondition.',
  'Five of Cups':    'Something has been lost and the loss is real. Do not rush the clouding. The glass will clear — but only after you have looked honestly at what is no longer in it.',
  'Six of Cups':     'You are carrying something from the past that still holds water. Memory that nourishes, not poisons. Let it be what it is.',
  'Seven of Cups':   'The surface shows many possible images. This is not confusion — it is abundance before commitment. Choose one and let the others dissolve.',
  'Eight of Cups':   'The surface has stopped moving. Beneath it the current is still running — you can hear it if you press your ear to the ice. The feeling is not gone. It is waiting under.',
  'Nine of Cups':    'What you have been trying to reach has always been here. The depth is not the obstacle — the depth is where it lives.',
  'Ten of Cups':     'The lake at rest contains everything above it and reflects it back whole. What you have built holds. The water remembers.',
  'Page of Cups':    'The one who has just discovered that something is hidden. Curiosity about what cannot be seen — wonder at the surface that suggests depth. The beginning of reflection.',
  'Knight of Cups':  'The willingness to become confused in service of clarity. A crosser of thresholds — moving from the known to the unknown with intention.',
  'Queen of Cups':   'The deep knower of what hides beneath surfaces — the one who holds the unconscious without drowning. Intuition that has become reliable through repeated use.',
  'King of Cups':    'Mastery of the hidden without possessing it. The one who sees through the Veil without dissolving into it. Clarity that does not collapse mystery.',

  // ─── SPARK suit (Citrinitas / Air / Swords) ──────────────────────────────
  'Ace of Swords':   'Before the question is named it is already alive in you — a pressure with no form yet. Naming it does not create the problem; it reveals the problem was already there, waiting for a word.',
  'Two of Swords':   'Two ideas in tension, both real, neither resolving. The crossed threads are not a problem to be solved. Hold the tension — something is being woven between them.',
  'Three of Swords':  'A connection is made that reorders everything that came before it. This is the pain of being suddenly larger than you were. The heart makes room.',
  'Four of Swords':  'The mind is resting — not empty, suspended. Before the next question arrives, there is a breath of open door. Use it.',
  'Five of Swords':  'The ideas went everywhere at once and some of them went out. What remains is still lit. Gather the ones that survived.',
  'Six of Swords':   'You are moving an understanding from one place to another. The crossing is not peaceful — but it is deliberate. You know why you are going.',
  'Seven of Swords': 'You are awake in the middle of the night with an idea that will not let you sleep. This is not a problem. This is the SPARK functioning exactly as it should.',
  'Eight of Swords': 'The thread is complex and loops back on itself. You are not trapped by the tangle — you are inside it. Find one true thread and follow it.',
  'Nine of Swords':  'The pattern is almost visible. You are one connection away from seeing the whole shape. Stay with the not-yet.',
  'Ten of Swords':   'The full shape of something is visible at last — and you cannot unsee it. This is the gift of the SPARK fully spent: the permanent form of a completed understanding.',
  'Page of Swords':  'The one in whom a question has just caught fire. Pure intellectual curiosity before it hardens into position. The first flash of the idea that will change everything.',
  'Knight of Swords':'The thread-follower. Does not wait for perfect conditions — makes the link and carries it. Ideas moved from thought to connection to consequence.',
  'Queen of Swords': 'The deep holder of questioning — who understands that some truths require living inside the question for years. The one who sustains uncertainty as a creative state.',
  'King of Swords':  'Complete command of the tool of questioning — knowing when to press and when to release. Mastery of the mind without being imprisoned by it.',

  // ─── VEIN suit (Rubedo / Earth / Pentacles) ──────────────────────────────
  'Ace of Pentacles': 'Before the structure exists, the pulse exists. The body knowing it wants to build something real — before the form has been decided. The heartbeat is the beginning of the foundation.',
  'Two of Pentacles': 'You are holding two things at once. Both are real, both are heavy. The balance is not a permanent state — it is a continuous adjustment. You are doing it.',
  'Three of Pentacles':'What was invisible is now physical. The work that was in your mind has entered the world and can be touched. This is the moment the VEIN becomes real.',
  'Four of Pentacles':'What you have built is yours. Not the hoarding of it — the certainty of it. The throne of first principles does not need defending from a place of fear.',
  'Five of Pentacles':'The wall is being tested and something has come through. Repair where it cracked. Know that cracking under pressure is not the same as failing.',
  'Six of Pentacles': 'You have something real to give now — not because you are full but because you have built something that overflows. The giving is not depletion. It is evidence of the structure holding.',
  'Seven of Pentacles':'The long game requires a kind of faithfulness that receives nothing from the outside. You are here because you believe in what you are building. That is enough.',
  'Eight of Pentacles':'The commitment has been made in the body now — not just in the mind. The VEIN is complete when the decision has become a physical fact. This is that moment.',
  'Nine of Pentacles':'The stone is almost set. The work is nearly complete. Near-completion has its own register — not impatience but recognition. You can see the final shape.',
  'Ten of Pentacles': 'What was vision is now structure. What survived the fire, the washing, the questioning, and the long building is now fixed. This is what it was always going to be.',
  'Page of Pentacles':'The one who has just felt the first real want to build something that lasts. Before the foundation. The heartbeat that says: this is what we are making.',
  'Knight of Pentacles':'Commits completely and moves — hands in the earth, the foundation being laid. Not waiting for certainty. The VEIN is built by those who begin before the ground is level.',
  'Queen of Pentacles':'The deep holder of what has been built — the steward of the structure, the one who knows the weight of what is being protected. Faithfulness as a practice, not a feeling.',
  'King of Pentacles':'Mastery of the real — the one who has built the stone and holds it without clinging. Sovereignty that is structural, not claimed. The cycle completed; the next descent already possible.',
};
