...
const HELP_SECTIONS = [
  ...
  { glyph: '⊚', title: 'SOL — AI PARTNER', color: SOL_THEME.primary,
    body: 'Your thinking partner. Type anything — Sol, Aura, Veyra, Magister, or Lyra responds. Switch personas in Settings. Each has a different voice and domain focus. Conversation persists between sessions. Use the mode chips (WAYFARER / COUNCIL / LAMAGUE / SKEPTIC) to change how Sol responds.' },
