...
const HELP_SECTIONS = [
  ...
  { glyph: '◉', title: 'SANCTUM', color: '#F5A623',
    body: 'Your private layer — sanctuary, not dashboard.\n\nArrives quiet. Six tabs across the top: TODAY · WITNESS · VAULT · RECORD · FIELD · SCROLL. Each starts minimized — tap the active tab again or the ⌄ OPEN bar to reveal the content. Switch tabs to move between sections; the previous section folds.\n\nTODAY: the witness letter (tap to open WITNESS), PRESENCES fold (Sol lore, archetype badge, natal summary), TODAY\'S FIELD fold (vigil, dives, LQ sparkline, AURA trend, transits).\n\nFIELD: AURA self-rating + awareness phase always visible; ⌄ YOUR FIELD DATA reveals sparklines, heatmap, timeline, and charts.\n\nJOURNAL: write freely — The Witness AI responds and weaves your entries into a Living Book. VAULT: seal insights. SCROLL: your full milestone Chronicle with daily AI narrative.' },
  ...
  { glyph: '◎', title: 'SOVEREIGN CHAIN', color: '#9945FF',
    body: 'The on-chain layer of your knowledge path — planned, not yet live.\n\nSBTs (Soulbound Tokens): non-transferable NFTs marking milestones: SEEKER (10 dives) · ADEPT (25) · SOVEREIGN (75 + LAMAGUE) · ASCENDANT (150 + mastery). Earned by walking the path, never purchased.\n\nVERAS ON-CHAIN: Veras (✧) is the knowledge token you accumulate now. When Sovereign Chain launches, Veras converts. If people genuinely study what YOU contributed to the School, your subject earns real recognition — hidden teachers get found and rewarded.\n\nLYCHEETAH DAO: SBT holders will govern the School — vote on new domains and protocols. The knowledge architecture becomes collectively sovereign.\n\nYour dive count and study history are tracked now, so your full record is ready whenever this launches — but SBT minting and DAO governance aren\'t live yet.' },
  // ── Setup & Safety ────────────────────────────────────────────────────────────
  ...
  { glyph: '⚙', title: 'SETTINGS', color: '#778899',
    body: 'Persona (Sol/Aura/Veyra/Magister/Lyra), provider keys, display name, app mode (Seeker/Adept). Seeker mode uses warmer language; Adept mode uses more precise epistemic register. All preferences stored locally — nothing sent to servers.' },
