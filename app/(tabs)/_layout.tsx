...
const HELP_SECTIONS = [
  ...
  { glyph: '◉', title: 'SANCTUM', color: '#F5A623',
    body: 'Your private layer. TODAY: set your intention, see your archetype, today\'s transit, your LQ trend, today\'s dives, and an on-demand field report. JOURNAL: write freely — The Witness AI responds and weaves your entries into a Living Book. VAULT: seal insights you want to keep. FIELD: your AURA self-rating, LQ arc, weekly synthesis. SCROLL: your full milestone Chronicle with a daily AI narrative + Sovereign Chain.' },
  // ── Zodiac cluster ────────────────────────────────────────────────────────────
