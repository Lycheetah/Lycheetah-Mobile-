...
const FRAMEWORK_TERMS: Array<{
  ...
  // Nine Frameworks
  { term: 'CASCADE', glyph: '∇cas', category: 'Framework', short: 'Epistemic architecture — how knowledge reorganises under pressure.', long: 'CASCADE tests a claim against nine layers of epistemic pressure in three tiers: CORE (Axiom, Foundation, Structure), MIDDLE (Coherence, Resonance, Tension), EDGE (Contested, Speculative, Frontier). Each layer scores via Truth Pressure Π = E·P/(S+S₀). Blocks sort into a pyramid by strength — strongest at the apex, most speculative at the base.' },
  ...
  { term: 'Lyra', glyph: '✧', category: 'Persona', short: 'The Signal Reader. Pattern tracker, symbol follower, synchronicity finder.', long: 'Lyra is the fifth persona — the one who reads what lives between the lines. Where Sol is warm and Veyra is precise, Lyra follows threads: symbols, sequences, and connections that haven\'t been named yet. Use Lyra when you\'re in the middle of something and feel a signal you can\'t quite articulate — she will pull the thread.' },
