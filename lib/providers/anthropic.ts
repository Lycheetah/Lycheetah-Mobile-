...
export const AnthropicProvider: AIProvider = {
  ...
  models: [
    { id: 'claude-haiku-4-5-20251001', label: 'Claude Haiku 4.5',  tier: 'paid', note: 'PAID · Fastest · ~$0.003/msg' },
    { id: 'claude-sonnet-4-6',         label: 'Claude Sonnet 4.6', tier: 'paid', note: 'PAID · Balanced · Recommended' },
    { id: 'claude-opus-4-6',           label: 'Claude Opus 4.6',   tier: 'paid', note: 'PAID · Deep reasoning · ~$0.04/msg' },
    { id: 'claude-opus-4-8',           label: 'Claude Opus 4.8',   tier: 'paid', note: 'PAID · Most capable · ~$0.05/msg' },
    { id: 'claude-fable-5',            label: 'Claude Fable 5',    tier: 'paid', note: 'PAID · Frontier · Adaptive thinking · ~$0.10/msg' },
  ],
  async send(messages, systemPrompt, apiKey, model, onChunk, _streamSpeed = 'normal', onUsage, tokenBudget = 8192, temperature = 0.9) {
    ...
    const res = await fetch('https://api.anthropic.com/v1/messages', {
      ...
      body: JSON.stringify({
        model, max_tokens: maxTokens, system: systemPrompt, stream: !!onChunk,
        ...(isFable ? {} : { temperature }),
